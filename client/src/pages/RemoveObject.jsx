...
const RemoveObject = () => {
    ...
    const onSubmitHandler = async (e) => {
      ...
      if (!object.trim()) {
        toast.error("Please enter object to remove")
        return
      }
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Describe object to remove.</p>
        ...
        <textarea
          ...
          placeholder='Describe object to remove...'
          required
        />
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
        ...
        </div>
        {
          !content ? (
            ...
            <img src={content} alt="content" className='mt-3 w-full h-full' />
          )
        }
